...
public class ReflectionHelper {
    ...
    static {
        setAccessible(ReflectionHelper.class);
    }
    ...
    public static void resetReflectionData(Class<?> clazz) {
    ...
    public static void set(Field field, Object val) {
        set(field, null, val);
    }
    ...
    @SuppressWarnings("unchecked")
    public static <R> R invoke(Method method, Object obj, Object... args) {
        try {
